...
#define _SHA256_DIGEST_LENGTH 8
  ...
  void _nettle_sha256_compress(uint32_t *state,
      const uint8_t *data,
      const uint32_t *k);
...
#define sha224_update nettle_sha256_update
  ...
  void sha224_digest(struct sha256_ctx *ctx, size_t length, uint8_t *digest);
...
#define _SHA512_DIGEST_LENGTH 8
  ...
  void sha512_update(struct sha512_ctx *ctx, size_t length, const uint8_t *data);

  void sha512_digest(struct sha512_ctx *ctx, size_t length, uint8_t *digest);
  ...
  /* Internal compression function. STATE points to 8 uint64_t words,
     ...
     points to the table of constants. */
  void _nettle_sha512_compress(uint64_t *state,
      const uint8_t *data,
      const uint64_t *k);
...
#define sha384_update nettle_sha512_update
  ...
  void sha384_digest(struct sha512_ctx *ctx, size_t length, uint8_t *digest);
...
#define sha512_224_ctx         sha512_ctx
  ...
  void sha512_224_init(struct sha512_224_ctx *ctx);

#define sha512_224_update nettle_sha512_update

  void sha512_224_digest(struct sha512_224_ctx *ctx,
      size_t length,
      uint8_t *digest);
...
#define sha512_256_ctx         sha512_ctx
  ...
  void sha512_256_init(struct sha512_256_ctx *ctx);

#define sha512_256_update nettle_sha512_update

  void sha512_256_digest(struct sha512_256_ctx *ctx,
      size_t length,
      uint8_t *digest);
