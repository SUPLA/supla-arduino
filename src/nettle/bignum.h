...
extern "C" {
  ...
  void nettle_mpz_random_size(mpz_t x,
      void *ctx,
   ...
   * 0 <= x < n. */
  void nettle_mpz_random(mpz_t x,
      void *ctx,
      nettle_random_func *random,
      const mpz_t n);

  void nettle_random_prime(mpz_t p,
      unsigned bits,
      int top_bits_set,
      void *ctx,
      nettle_random_func *random,
  ...
  void _nettle_generate_pocklington_prime(mpz_t p,
      mpz_t r,
      unsigned bits,
      int top_bits_set,
      void *ctx,
  ...
  int nettle_asn1_der_get_bignum(struct asn1_der_iterator *iterator,
      mpz_t x,
      unsigned max_bits);
